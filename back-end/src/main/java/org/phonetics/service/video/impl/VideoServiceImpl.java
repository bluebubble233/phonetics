package org.phonetics.service.video.impl;
...
import org.phonetics.config.LocalCache;
import org.phonetics.config.QiNiuConfig;
import org.phonetics.constant.AuditStatus;
import org.phonetics.constant.RedisConstant;
import org.phonetics.entity.File;
import org.phonetics.entity.task.VideoTask;
import org.phonetics.entity.user.User;
...
import org.phonetics.entity.vo.BasePage;
import org.phonetics.entity.vo.HotVideo;
import org.phonetics.entity.vo.UserModel;
import org.phonetics.entity.vo.UserVO;
import org.phonetics.exception.BaseException;
import org.phonetics.holder.UserHolder;
import org.phonetics.mapper.video.VideoMapper;
import org.phonetics.service.FeedService;
import org.phonetics.service.FileService;
import org.phonetics.service.InterestPushService;
import org.phonetics.service.audit.VideoPublishAuditServiceImpl;
import org.phonetics.service.user.FavoritesService;
import org.phonetics.service.user.FollowService;
import org.phonetics.service.user.UserService;
import org.phonetics.service.video.TypeService;
import org.phonetics.service.video.VideoService;
import org.phonetics.service.video.VideoShareService;
import org.phonetics.service.video.VideoStarService;
import org.phonetics.util.FileUtil;
